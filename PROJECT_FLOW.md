...
将 `X射线探伤.pdf` 第四部分中的题目整理为一个手机可访问、可互动答题、可记录错题的题库应用。
...
```text
C:\CB\4-My work\424冷阴极X射线源\5其他\省辐射安全考试\X射线探伤.pdf
```

题目来自 PDF 第四部分，答案也从第四部分答案区整理。
...
```powershell
magick `
  assets\questions\q407_part1.jpg `
  assets\questions\q407_part2.jpg `
  -append `
  assets\questions\q407.jpg
```
